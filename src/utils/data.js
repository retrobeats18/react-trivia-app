const allTrivia = [
    ...
    },
    {
        category: "The Office",
        question: "What is the name of the company's HR representative?",
        options: ["Toby Flenderson", "Angela Martin", "Phyllis Vance", "Stanley Hudson"],
        answer: "Toby Flenderson"
      },
      {
        category: "The Office",
      ...
      },
      {
        category: "The Office",
        question: "What is the name of the paper company in The Office?",
        options: ["Dunder Mifflin", "Scranton Paper Co.", "Paper Paradise", "Sabre"],
        answer: "Dunder Mifflin"
      },
      {
        category: "The Office",
        question: "Who is known for their unique fashion sense and love for cats?",
        options: ["Kevin Malone", "Phyllis Vance", "Stanley Hudson", "Angela Martin"],
        answer: "Angela Martin"
      },
      {
        category: "The Office",
        question: "Which character is known for their love of pretzel day?",
        options: ["Stanley Hudson", "Michael Scott", "Dwight Schrute", "Andy Bernard"],
        answer: "Stanley Hudson"
      },
      {
        category: "Friends",
      ...
      {
        category: "Friends",
        question: "What song is Ross playing on the keyboard when he insists everyone to join in?",
        options: ["Twinkle, Twinkle, Little Star", "The Entertainer", "Funky Town", "Axel F"],
      ...
      },
      {
        ...
        options: ["Richmond Rovers", "London Lions", "AFC Wimbledon", "FC Richmond"],
        answer: "FC Richmond"
      },
      {
        category: "Ted Lasso",
      ...
      },
      {
        ...
        options: ["Rebecca Welton", "Hannah Waddingham", "Keeley Jones", "Juno Temple"],
        answer: "Rebecca Welton"
      },
      {
        category: "Ted Lasso",
        question: "What does AFC stand for in the team's name?",
        options: ["Athletic Football Club", "Association Football Club", "Alliance Football Club", "American Football Club"],
        answer: "Association Football Club"
      },
      {
        category: "Ted Lasso",
        question: "What is Ted Lasso's motivational phrase for the team?",
        options: ["Believe", "Winning is Everything", "Never Give Up", "Be a Goldfish"],
        answer: "Be a Goldfish"
      },
      {
        category: "Ted Lasso",
        question: "Which player has a unique celebration dance when scoring a goal?",
      ...
      },
      {
        ...
        options: ["The Anchor & Hope", "The Crown & Anchor", "The Richmond Tavern", "The Prince's Head"],
